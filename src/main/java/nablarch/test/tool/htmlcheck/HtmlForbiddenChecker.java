...
import nablarch.test.tool.htmlcheck.parser.Token;
 ...
 */
public class HtmlForbiddenChecker {

    /** ロガー */
    private static final Logger LOGGER = LoggerManager.get(HtmlForbiddenChecker.class);
     ...
     */
    public HtmlForbiddenChecker(HtmlForbiddenNodeConf conf) {
        this.conf = conf;
    }
