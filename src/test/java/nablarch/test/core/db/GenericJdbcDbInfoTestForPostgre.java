 ...
 */
@TargetDb(include = Db.POSTGRE_SQL)
public class GenericJdbcDbInfoTestForPostgre extends GenericJdbcDbInfoTestBase {
    ...
    public void testGetColumnType() {
        ...
        // number
        assertThat(dbInfo.getColumnType("non_pk", "number_col"), is(java.sql.Types.NUMERIC));
        // blob
        assertThat(dbInfo.getColumnType("non_pk", "blob_col"), is(java.sql.Types.BINARY));
        // date
