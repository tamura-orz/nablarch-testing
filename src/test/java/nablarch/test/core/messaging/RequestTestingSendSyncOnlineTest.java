    ...
    public void testOnline() {
        ...
        execute("testSendSync", new BasicAdvice() {
            ...
            public void afterExecute(TestCaseInfo testCaseInfo, ExecutionContext context) {
                ...
                // ヘッダ
                assertThat(responseMessage2.getHeaderRecord().get("requestId").toString(), is("test"));
                assertThat(responseMessage2.getHeaderRecord().get("resendFlag").toString(), is("9"));
                assertThat(responseMessage2.getHeaderRecord().get("testCount").toString(), is("123"));
                assertNull(responseMessage.getHeaderRecord().get("reserved"));
                // 本文
                ...
                // ヘッダ
                assertThat(responseMessage4.getHeaderRecord().get("requestId").toString(), is("RM11AD0101"));
                assertThat(responseMessage4.getHeaderRecord().get("resendFlag").toString(), is("9"));
                assertThat(responseMessage4.getHeaderRecord().get("testCount").toString(), is("123"));
                assertNull(responseMessage4.getHeaderRecord().get("reserved"));
                // 本文
                assertThat(responseMessage4.getDataRecord().get("failureCode").toString(), is("test1"));
                assertThat(responseMessage4.getDataRecord().get("userInfoId").toString(), is("user1"));
